from crome_logic.src.crome_logic.specification import Specification
from crome_logic.src.crome_logic.specification.string_logic import and_, f_, g_, implies_, not_, or_, x_, iff_
