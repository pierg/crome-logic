...
class InitInstantaneousReaction(Trigger):
    ...
    arguments = [
        {"name": "trigger", "format": "value", "type": "any"},
...
class InitBoundReaction(Trigger):
    ...
    description = (
        "At the first step, a counteraction must be performed every time and only when a specific location "
        "is entered. "
    )
    arguments = [
        {"name": "trigger", "format": "value", "type": "any"},
...
class InitBoundDelay(Trigger):
    ...
    description = (
        "At the first step, a counteraction must be performed, in the next time instant, every time and "
...
class InitPromptReaction(Trigger):
    ...
    description = (
        "At the first step, the occurrence of a stimulus triggers a counteraction promptly, i.e in the next "
        "time instant."
    )
    arguments = [
        {"name": "trigger", "format": "value", "type": "any"},
...
class InstantaneousReaction(Trigger):
    ...
    description = (
        "The occurrence of a stimulus instantaneously triggers a counteraction."
    )
    arguments = [
        {"name": "trigger", "format": "value", "type": "any"},
        {"name": "reaction", "format": "value", "type": "any"},
...
class BoundDelay(Trigger):
    name = "Bound Delay"
    description = (
        "A counteraction must be performed, in the next time instant, every time and only when a "
...
class PromptReaction(Trigger):
    ...
    description = (
        "The occurrence of a stimulus triggers a counteraction promptly, i.e in the next time "
        "instant."
    )
    arguments = [
        {"name": "trigger", "format": "value", "type": "any"},
...
class DelayedReaction(Trigger):
    ...
    description = (
        "The occurrence of a stimulus triggers a counteraction some time later."
    )
    arguments = [
        {"name": "trigger", "format": "value", "type": "any"},
        {"name": "reaction", "format": "value", "type": "any"},
